...
class Window(object):
    def __init__(self, master):
        ...
        self.tempo_label = Label(self.content, text="Set bpm")
        ...
        self.scale_label.grid(column=0, row=1)
        self.scale_menu.grid(column=1, row=1)
        self.tonic_label.grid(column=0, row=2)
        self.tonic_menu.grid(column=1, row=2)
        self.tempo_label.grid(column=0, row=3)
        self.tempo_text.insert(END, "150")
        self.tempo_text.grid(column=1, row=3)
        self.instrument_label.grid(column=0, row=4)
        self.instrument_menu.grid(column=1, row=4)
        self.filename_label.grid(column=0, row=5)
        self.filename_text.insert(END, "output")
        self.filename_text.grid(column=1, row=5)
        self.separator_label.grid(column=0, row=6, columnspan=2)
        self.status_label.grid(column=0, row=7, columnspan=2)
        self.button.grid(column=0, row=8, columnspan=2)
